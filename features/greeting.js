module.exports = function(controller) {
    ...
    controller.on('connected', async(bot, message) => {
        await bot.reply(message, `Hello! 👋 I'm QBot, the digital avatar for my creator Marquis Bentley. I'm a Software Engineer in the San Francisco Bay Area, currently open to new opportunities, and looking to grow my network. Come get to know me better!`);
